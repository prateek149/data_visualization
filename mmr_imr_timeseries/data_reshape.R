...
write.csv(imr, "/Users/prateekmittal/Desktop/skill_development/portfolio/visualizations/mmr_imr_timeseries/data/imr_long.csv", row.names = F)
...
write.csv(mmr, "/Users/prateekmittal/Desktop/skill_development/portfolio/visualizations/mmr_imr_timeseries/data/mmr_long.csv", row.names = F)
